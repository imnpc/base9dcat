...
return [
    'disk' => config('filesystems.default'),//Filesystem Disk,默认值取后台设置的值，
    'hash_filename' => 1,
    ...
    'snapscreenPathFormat' => '/uploads/php/image/{yyyy}{mm}{dd}/{time}{rand:6}', /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    'catcherPathFormat' => '/uploads/php/image/{yyyy}{mm}{dd}/{time}{rand:6}', /* 上传保存路径,可以自定义保存路径和文件名格式 */
    'catcherUrlPrefix' => '', /* 图片访问路径前缀 */
    'catcherMaxSize' => 204800000, /* 上传大小限制，单位B */
